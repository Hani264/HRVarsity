...
let CourseDetailsComponent = class CourseDetailsComponent {
    constructor(commonServices, route) {
    ...
    getCourseDetails() {
        ...
        this.commonServices.getCourseDetails(id).subscribe(course => this.course = course);
    }
    getCourses() {
        this.commonServices.getCourses().subscribe(courses => this.courses = courses);
    }
    loadScript(url) {
