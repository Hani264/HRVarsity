...
const routes = [
    ...
    { path: "courses", loadChildren: () => __webpack_require__.e(/*! import() | courses-courses-module */ "courses-courses-module").then(__webpack_require__.bind(null, /*! ./courses/courses.module */ "./src/app/courses/courses.module.ts")).then(m => m.CoursesModule) },
    { path: "gallery", loadChildren: () => __webpack_require__.e(/*! import() | gallery-gallery-module */ "gallery-gallery-module").then(__webpack_require__.bind(null, /*! ./gallery/gallery.module */ "./src/app/gallery/gallery.module.ts")).then(m => m.GalleryModule) },
...
let ContactFormDailogComponent = class ContactFormDailogComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let HomeComponent = class HomeComponent {
    ...
    getCourses() {
        this.commonServices.getCourses().subscribe(courses => this.courses = courses.slice(0, 4));
    }
    getBlogs() {
